...
const getAllBooks = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield book_model_1.Book.find({}).sort({ updatedAt: -1 }).lean();
    return result;
});
...
const updateBook = (id, book, userId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (doesExist.createdBy.toString() !== userId) {
        throw new ApiError_1.default(http_status_1.default.FORBIDDEN, 'You are not authorized to update this book !');
    }
